...
Related: the same missing-manifest problem makes concurrent builds destructive (separate issue).

Evidence: `a3-summary.txt`, `a3-rebuild-after-kill-fails.log`, `a2-gomod-during-build.txt`.
