...
Labels: `bug`
Suggested milestone: fix before v1 — this is the general mechanism behind #494
...
Matching recorded `@v1.70.0` paths; tidy bumped grpc to v1.82.0 to satisfy the injected hook module; the compile received `@v1.82.0` sources. This is almost certainly the mechanism behind #494.
...
Evidence logs: `a2-grpc-pinned-low.log`, `a2-go124-directive.log`.
